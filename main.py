...
xgboost_futureEngineered_model = load_model("xgboost-featureEngineered.pkl")
...
def prepare_input(credit_score, location, gender, age, tenure, balance, num_products, has_credit_card, is_active_member, estimated_salary):
  ...
  input_dict = {
    ...
    'IActiveMember': int(is_active_member),
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  You noticed that a customer named {surname} has a {round(probability * 100, 1)}% of churning.
  ...
  Make sure to list out a list of incentives to stay based on their information, in bullet point format. Don't ever mention the probability of churning, or the machine learning model to the customer.
